<div class = "container">
    <div class = "row">
        ...
        if (!empty($_POST)) {
            ...
            //var_dump($date);
            $reservationDB = new ReservationDB($cnx);
            $newReservation = [
                "BUDGET" => $_POST["budget"],
                "DATE" => $_POST["date"],
            ...
            $success = $reservationDB->addReservation($newReservation);
            if ($success) {
            ...
            <div class = "tour-booking-form">
                <form method="post">
                    <div class = "row">
                                ...
                                <div class = "select">
                                    <select id = "select" name = "destination" class = "form-control">
                                        ...
                                        foreach ($datas as $data):
                                            ?>
                                            <option value = "<?= $data["ID"]; ?>"><?= $data["PAYS"]; ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class = "col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class = "form-group">
                                <label class = "control-label required" for = "nbre">Nombre de personnes</label>
                                <div class = "select">
                        ...
                        <div class = "col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                            <div class = "form-group">
                                <label class = "control-label required" for = "budget">Budget</label>
                                <div class = "select">
